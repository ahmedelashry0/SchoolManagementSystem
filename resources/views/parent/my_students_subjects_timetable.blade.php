            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @foreach($student->student_class->classSubjects as $classSubject)
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                            @if($classSubject->subject->timetables->isNotEmpty())
                                                @foreach($classSubject->subject->timetables as $timetable)
                                                    <tr>
